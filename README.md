...
Vissa av er kan förmodligen mer eller mindre än andra av er. Så under denna vecka vill vi se till att alla har en stabil och likvärdig grund som vi sedan kan bygga vidare på. Även om ni kan mycket redan vill vi att ni kollar igenom det som ligger här. Kanske kan ni få några tips eller lära er något nytt. 
...
**Vi förväntar oss att ni kan det som ligger i denna planering inför kurstart.**
...
Titta på videon och testa själv: [Version control in Visual Studio Code](https://code.visualstudio.com/docs/introvideos/versioncontrol)
...
(om ni vill läsa mer: [Structuring the web with HTML](https://developer.mozilla.org/en-US/docs/Learn/HTML)) 
...
Titta på och testa teknikerna som visas här (föredrar ni någon annan webbläsare får ni själva leta upp instruktioner): [https://www.youtube.com/watch?v=ndeClnyHSo8](https://www.youtube.com/watch?v=ndeClnyHSo8)
...
3. Ladda upp ditt projekt på GitHub (gör gärna löpande commits under arbetet). Vi kan komma att be om länk till ditt repo för projektet under intervjun. **Inget ska skickas in till oss.**
